...
\begin{center}
  ...
  {\small Version 1.1 \quad\textbullet\quad Requires Lua\LaTeX}
\end{center}
...
\begin{tabular}{@{}lll@{}}
  ...
  \opt{modDepth}       & \opt{1.0cm}  & Minimum diagonal slant length for modifiers/preps \\
...
Use \cmd{rkCompoundSent} to diagram two independent clauses in a single picture, connected by a dashed-line bridge with the coordinating conjunction:
...
\begin{itemize}\setlength\itemsep{2pt}
  ...
  \item \texttt{\{opts1\}} / \texttt{\{opts2\}} — per-clause \cmd{rkset}-style options
...
\begin{tabular}{@{}lp{8.5cm}@{}}
  ...
  \cmd{rkCompoundSent[conj][sep]\{opts1\}\{body1\}\{opts2\}\{body2\}} &
    Two independent clauses in one picture, connected by a dashed bridge \\
  \bottomrule
\end{tabular}
