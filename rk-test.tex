...
\testcase{Rapid swimming exhausts him.}{%
  \begin{rkdiagram}
    \rkSubject[\rkAdj{Rapid}]{\rkGerund{swimming}}
    \rkVerb{exhausts}
    \rkDObj{him}
  \end{rkdiagram}
  \par\textit{Tests: gerund as subject with adjective modifier.}
}
...
\testcase{She is good at running quickly.}{%
  \begin{rkdiagram}
    \rkSubject{She}
    \rkVerb{is}
    \rkPredAdj[\rkPrep[\rkAdv{quickly}]{at}{\rkGerund{running}}]{good}
  \end{rkdiagram}
  \par\textit{Tests: gerund as object of a preposition.}
}
