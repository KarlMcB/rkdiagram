...
% ============================================================
\testsection{Group 13 — Manual Spacing Controls}
% ============================================================
...
\testcase{His hobby is collecting stamps.}{%
  \begin{rkdiagram}
    \rkSubject[\rkAdj{His}]{hobby}
    \rkVerb{is}
    \rkPredNom{\rkGerund{collecting}}
  \end{rkdiagram}
...
% ============================================================
\testsection{Group 15 — Participles}
% ============================================================
...
\testcase{He wants to run in the race.}{%
  \begin{rkdiagram}
    \rkSubject{He}
    \rkVerb{wants}
    \rkDObj{\rkInfinitive[\rkPrep[\rkAdj{the}]{in}{race}]{run}}
  \end{rkdiagram}
...
\testcase{He found books to read.}{%
  \begin{rkdiagram}
    \rkSubject{He}
    \rkVerb{found}
    \rkDObj[\rkInfinitive{read}]{books}
  \end{rkdiagram}
...
\testcase{She came to win the prize.}{%
  \begin{rkdiagram}
    \rkSubject{She}
    \rkVerb[\rkInfinitive[\rkInfObj{prize}]{win}]{came}
  \end{rkdiagram}
...
\testsection{Group 17 — Nominative Absolutes}
...
\testcase{The sun setting, they departed.}{%
  \begin{rkdiagram}
    \rkSubject{they}
    \rkVerb{departed}
    \rkNomAbs[\rkAdj{The}]{sun}{}{setting}
  \end{rkdiagram}
...
\testcase{His work finished, he ran.}{%
  \begin{rkdiagram}
    \rkSubject{he}
    \rkVerb{ran}
    \rkNomAbs[\rkAdj{His}]{work}{\rkPartObj{done}}{finished}
  \end{rkdiagram}
...
\testcase{His staff grasped in his hand, the old man walked the long road slowly.}{%
  \begin{rkdiagram}
    \rkSubject[\rkAdj{The}\rkAdj{old}]{man}
    \rkVerb[\rkAdv{slowly}]{walked}
    \rkDObj[\rkAdj{the}\rkAdj{long}]{road}
    \rkNomAbsHeight{4cm}
    \rkNomAbs[\rkAdj{his}]{staff}{\rkPrep[\rkAdj{his}]{in}{hand}}{grasped}
  \end{rkdiagram}
