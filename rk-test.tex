...
% ============================================================
\testsection{Group 18 — Stress Test: Nabokov}

\testcase{As he crossed toward the pharmacy at the corner he involuntarily
turned his head because of a burst of light that had ricocheted from his
temple, and saw, with that quick smile with which we greet a rainbow or a
rose, a blindingly white parallelogram of sky being unloaded from the
van---a dresser with mirrors across which, as across a cinema screen,
...
who were carrying this sky, these boughs, this gliding fa\c{c}ade.}{%
  \begin{rkdiagram}
    \rkSubject{he}
    \rkVerb{%
      \rkCompound[and][
  ...
  \end{rkdiagram}
  \par\textit{Tests: stress test --- compound predicate, nested relative and
  adverbial clauses, gerund-free but participle-heavy modifier chains, deep
  prepositional nesting. (Vladimir Nabokov, ``The Leonardo'', 1933.)}
}
